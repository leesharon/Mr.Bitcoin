...
export class ContactService {
  ...
  public query() {
    ...
    this._contactsDb = this.storageService.loadFromStorage('contacts')
    if (!this._contactsDb) {
  ...
  public getContactById(id: string): Observable<Contact> {
    ...
    const contacts: Contact[] = this.storageService.loadFromStorage('contacts')
  ...
  public deleteContact(id: string) {
    ...
    const contacts = this._contactsDb.filter((contact) => contact._id !== id)
    this.storageService.saveToStorage('contacts', contacts)
  ...
  private _addContact(contact: Contact) {
    let contacts: Contact[] = this.storageService.loadFromStorage('contacts')
    //mock the server work
